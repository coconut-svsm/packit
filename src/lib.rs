...
mod tests {
    ...
    #[test]
    fn decode() {
        let data = [80, 75, 73, 84, 8, 0, 0, 0, 1, 0, 2, 0, 9, 0, 0, 0, 0, 0, 0, 0, 102, 49, 115, 111, 109, 101, 32, 100, 97, 116, 97, 1, 0, 2, 0, 14, 0, 0, 0, 0, 0, 0, 0, 102, 50, 115, 111, 109, 101, 32, 109, 111, 114, 101, 32, 100, 97, 116, 97, 1, 0, 5, 0, 15, 0, 0, 0, 0, 0, 0, 0, 102, 51, 47, 102, 52, 101, 118, 101, 110, 32, 109, 111, 114, 101, 32, 100, 97, 116, 97, 33];
